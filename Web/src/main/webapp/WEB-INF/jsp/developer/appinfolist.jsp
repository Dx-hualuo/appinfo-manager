<jsp:useBean id="dev_user" scope="session" type="com.night.appinfo.entity.DevUser"/>
    ...
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <script>
                    //获得查询所用参数
                    const param = <%=JSON.toJSONString(request.getAttribute("param"))%>
                </script>
                <form method="post" action="${pageContext.request.contextPath}/dev/appInfo">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="querySoftwareName" type="text" class="form-control col-md-7 col-xs-12" value="${param.querySoftwareName}">
                                </div>
                            </div>
                        </li>
                        <li>
                                    ...
                                    <select name="queryStatus" class="form-control">
                                        <c:if test="${statusList != null}">
                                            ...
                                            <c:forEach var="dataDictionary" items="${statusList}">
                                                <option
                                                        <c:if test="${dataDictionary.valueId == param.queryStatus}">selected="selected"</c:if>
                                    ...
                                    <select name="queryFlatformId" class="form-control">
                                        <c:if test="${flatFormList != null}">
                                            ...
                                            <c:forEach var="dataDictionary" items="${flatFormList}">
                                                <option
                                                        <c:if test="${dataDictionary.valueId == param.queryFlatformId}">selected="selected"</c:if>
                                                        value="${dataDictionary.valueId}">${dataDictionary.valueName}</option>
                                            </c:forEach>
                                        </c:if>
                                    </select>
                                    ...
                                    <select id="queryCategoryLevel1" name="queryCategoryLevel1" class="form-control">
                                        <c:if test="${categoryLevel1List != null }">
                                            ...
                                            <c:forEach var="appCategory" items="${categoryLevel1List}">
                                                <option
                                                        <c:if test="${appCategory.id == param.queryCategoryLevel1 }">selected="selected"</c:if>
                                    ...
                                    <select name="queryCategoryLevel2" id="queryCategoryLevel2" class="form-control">
                                        <c:if test="${categoryLevel2List != null}">
                                            ...
                                            <c:forEach var="appCategory" items="${categoryLevel2List}">
                                                <option
                                                   <c:if test="${appCategory.id == param.queryCategoryLevel2}">selected="selected"</c:if>
                                    ...
                                    <select name="queryCategoryLevel3" id="queryCategoryLevel3" class="form-control">
                                        <c:if test="${categoryLevel3List != null }">
                                            ...
                                            <c:forEach var="appCategory" items="${categoryLevel3List}">
                                                <option
                                                    <c:if test="${appCategory.id == param.queryCategoryLevel3 }">selected="selected"</c:if>
                                                        value="${appCategory.id}">${appCategory.categoryName}
                                                </option>
                                            </c:forEach>
                                        </c:if>
        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="${pageContext.request.contextPath}/dev/appInfo/add" class="btn btn-success btn-sm">新增APP基础信息</a>
                            <table id="datatable-responsive"
                                ...
                                <tbody>
                                <c:forEach var="appInfo" items="${pages.resultList}" varStatus="status">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="dataTables_info" id="datatable-responsive_info"
                                ...
                                ${pages.pageNo}/${pages.totalPage}页
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="dataTables_paginate paging_simple_numbers"
                                ...
                                <ul class="pagination">
                                    ...
                                    <c:if test="${pages.pageNo < pages.totalPage}">
                                        <li class="paginate_button ">
                                            <a href="javascript:page_nav(document.forms[0],${pages.pageNo+1});"
                                                aria-controls="datatable-responsive" data-dt-idx="1"
                                                tabindex="0">
                                                下一页
                                            </a>
                                        ...
                                        <li class="paginate_button next">
                                            <a href="javascript:page_nav(document.forms[0],${pages.totalPage});"
