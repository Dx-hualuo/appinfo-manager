...
<head>
    ...
    <script>
        const hostPath = "${pageContext.request.contextPath}";
    </script>
            ...
            <div class="left_col scroll-view">
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> APP应用管理<span
                                ...
                                <ul class="nav child_menu">
                                    <li><a href="${pageContext.request.contextPath }/dev/appInfo">APP维护</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="sidebar-footer hidden-small">
                    ...
                    <span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span>
                        ...
                        href="${pageContext.request.contextPath}/dev/user/logout"> <span
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class=""><a href="javascript:;"
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <li><a
                                        href="${pageContext.request.contextPath}/dev/user/logout"><i
                        ...
                        <li role="presentation" class="dropdown">
                            ...
                            <ul id="menu1" class="dropdown-menu list-unstyled msg_list"
                                ...
                                <li><a> <span class="image"><img
                                    ...
                                    <span class="message"> Film festivals used
												to be do-or-die moments for movie makers. They were where...
										</span> </a></li>
                                <li><a> <span class="image"><img
                                        src="${pageContext.request.contextPath}/statics/images/img.jpg"
